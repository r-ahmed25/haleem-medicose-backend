...
export const addToCart = async (req, res) => {
    try {
        ...
        const existingItemIndex = user.cartItems.findIndex(item => item.productId.toString() === productId.toString());
...
export const getCartItems = async (req, res) => {
    try {
        ...
        const validCartItems = user.cartItems.filter(item =>
...
export const updateQuantity = async (req, res) => {
    try {
        ...
        if (quantity <= 0) {
            ...
            user.cartItems = user.cartItems.filter(item => item._id.toString() !== itemId.toString());
            await user.save({ validateBeforeSave: false });
        ...
        const existingItemIndex = user.cartItems.findIndex(item => item._id.toString() === itemId.toString());
        if (existingItemIndex > -1) {
